...
background = pygame.image.load(r'lab8\Racer\AnimatedStreet.png') #загружаем фон
...
class Monet(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r'lab8\Racer\Monet.png')
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40,SCREEN_WIDTH-40), 0)
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound(r'lab8\Racer\crash.wav').play()
          time.sleep(1)
